<%@ page language="java" import="com.wj.wechat.service.*"  contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
//   out.println( name+" is "+addr);
  ...
  wx.config({
      debug: true,
      appId: '<% out.print( dat.getAppId() );      //  'wx66dded684c14bfd1', %>',
      timestamp: <% out.print( dat.getTimestamp() );      //  1506054511, %>,
      nonceStr: '<% out.print( dat.getNonceStr() );      //  'Nw3Y9HZkPsZtgBbB',%>',
      signature: '<% out.print( dat.getSignature() );      //  '75aa2a252a29b41005d62ca4c7f6559029b17d46',%>',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
